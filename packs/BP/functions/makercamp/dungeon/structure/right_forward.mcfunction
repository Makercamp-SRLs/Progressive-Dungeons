# © Makercamp SRLS, 2022
# authors: Fabrimat
# description: Paste right-forward shape
...
execute @s[tag=!forcing] ~ ~ ~ tellraw @a[tag=debug] {"rawtext":[{"text":"[Debug] Paste normal right-forward"}]}
execute @s[tag=forcing] ~ ~ ~ tellraw @a[tag=debug] {"rawtext":[{"text":"[Debug] Paste forced right-forward"}]}